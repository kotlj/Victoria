...
ghost-role-information-vitz-efreitor-rules = Вы солдат корпорации Витезтви, и в команде с тем, кто вас призвал. Стреляйте по всем, кого вам укажут, ибо за вопросы вам не платят. Слушайтесь старшину. Не стреляйте по своим. У професиональных наёмников должны быть принципы.
ghost-role-information-vitz-starshina-rules = Вы полевой офицер корпорации Витезтви, и в команде с тем, кто вас призвал. Разберитесь в ситуации, стреляйте по всем, кого вам укажут, ибо за вопросы вам не платят. Командуйте отрядом. Не стреляйте по своим. У професиональных наёмников должны быть принципы.

Vitz-Category = Витезтви